...
<div style="display: flex; overflow-x: auto; gap: 6px; white-space: nowrap;">
  <a href="#-themes"><img src="https://img.shields.io/badge/Themes-517bbd" /></a>
  <a href="#-key-features"><img src="https://img.shields.io/badge/Key_Features-517bbd" /></a>
  <a href="#-credits-&-acknowledgments"><img src="https://img.shields.io/badge/Credits_&_Acknowledgments-517bbd" /></a>
</div>

## Themes 
<details open>
  <summary style="font-size: 1.2em; font-weight: bold; cursor: pointer;">🧊 Blender 5+</summary>
  ...
  <!-- 01: Visuals -->
  <div style="display: flex; overflow-x: auto; gap: 10px; white-space: nowrap; margin-top: 10px; margin-bottom: 15px;">
    <img src="./images/blender/BlendGrey_1.1.0_blender_5_sc_layout.png" width="800px" />
    <img src="./images/blender/BlendGrey_1.1.0_blender_5_sc_shading.png" width="800px" />
    <img src="./images/blender/BlendGrey_1.1.0_blender_5_sc_animation.png" width="800px" />
    <img src="./images/blender/BlendGrey_1.1.0_blender_5_sc_geonodes.png" width="800px" />
    <img src="./images/blender/BlendGrey_1.1.0_blender_5_sc_scripting.png" width ="800px" />
  </div>

   <!-- 02: Instructions -->
  <div style="background-color: #676767; color: #000; padding: 15px; margin-bottom: 1.5em; border-radius: 8px; border: 1px solid #000000;">
    ...
    <!-- Warning div -->
    <div style="background-color: #3a3a3a; color: #FFF; padding: 8px 12px; border-radius: 8px; margin-left: 40px;">
    ...
    <ol start="4" style="margin-top: 10px;">
     ...
     <!-- Typography note div -->
    <div style="color: #000; padding: 8px 12px; border-radius: 8px; margin-left: 40px; border: 1px solid #000000;">
...
<details>
  <summary style="font-size: 1.2em; font-weight: bold; cursor: pointer;">💻 VSCode</summary>
  ...
  <div style="display: flex: overflow-x: auto; gap: 10px; white-space: nowrap;">
    <img src="./images/vscode/BlendGrey_VSCode_v1.0.0.png" width = "800px">
  </div>
  <div style="background-color: #676767;color: #000; padding: 8px 12px; margin-top: 10px; border-radius: 8px; border: 1px solid #000000;">
